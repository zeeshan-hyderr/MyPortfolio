...
const DashboardHome = () => {
  ...
  useEffect(() => {
    Promise.all([
      ...
      setStats({ projects: p.data.length, certifications: c.data.length, skills: s.data.length, messages: m.data.length });
    });
  }, []);
  ...
  return (
    <div>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <StatCard label="Certifications" value={stats.certifications || 0} to="/admin/certifications" />
      ...
      <div className="card mt-8">
        ...
        <ul className="text-sm text-ink-muted list-disc list-inside space-y-1">
          ...
          <li>Upload certifications with image or PDF files and publish them instantly.</li>
